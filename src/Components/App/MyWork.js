...
const MyWork = () => (
  <div>
    ...
    <main id="workContainer">
      ...
      <section className="workPortfolio">
        <section className="front">
          <img src={AddressBook} className="workImg" alt="AddressBook" />
        </section>
        <section className="back">
          <span className="strong">Project Name:</span>
      ...
      <section className="workPortfolio">
        <section className="front">
          <img src={ColorsRedux} className="workImg" alt="ColorsRedux" />
        </section>
        <section className="back">
          <span className="strong">Project Name:</span>
      ...
      <section className="workPortfolio">
        <section className="front">
          <img src={GitFitter} className="workImg" alt="GitFitter" />
        </section>
        <section className="back">
          <span className="strong">Project Name:</span>
      ...
      <section className="workPortfolio">
        <section className="front">
          <img src={NumberGif} className="workImg" alt="Number gif" />
        </section>
        <section className="back">
          <span className="strong">Project Name:</span>
      ...
      <section className="workPortfolio">
        <section className="front">
          <img src={Bomdigity} className="workImg" alt="Bomdigity" />
        </section>
      ...
      <section className="workPortfolio">
        <section className="front">
          <img src={flashcard} className="workImg" alt="Flashcard gif" />
        </section>
        <section className="back">
          <span className="strong">Project Name:</span>
      ...
      {/*<section className="workPortfolio">*/}
      {/*  <section className="front">*/}
      {/*    <img src={FIRE} className="workImg" alt="FIRE" />*/}
      {/*  </section>*/}
      {/*  <section className="back">*/}
      {/*    <span className="strong">Project Name:</span>*/}
      ...
      <section className="workPortfolio">
        <section className="front">
          <img src={check} className="workImg" alt="Check writting" />
        </section>
        <section className="back">
          <span className="strong">Project Name:</span>
